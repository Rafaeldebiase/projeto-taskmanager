...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.rafaeldebiase.taskmanager.resource"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API para gerenciamento de tarefas",
				"Seu consumo se destina a sistemas.", 
				"Versão 1.0",
				"",
				new Contact("Rafael de Biase", 
						"", "rafaelvitaldebiase@gmail.com"),
